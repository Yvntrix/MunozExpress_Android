...
public class Confirmed_Orders extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.confirmedOrders);
        ...
        usersRef.child("Pasundo").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for(DataSnapshot datas: dataSnapshot.getChildren()){
                    ...
                    String confirm = datas.child("Ongoing").getValue().toString();
